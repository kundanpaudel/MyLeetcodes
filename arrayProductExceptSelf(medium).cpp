...
*/
    vector<int> productExceptSelf(vector<int>& nums) {
        ...
        for(int i = 0; i<nums.size(); i++){ // Iterating through the nums array.
        ...
        for(int i = nums.size()-1; i>=0; i--){ // Iterating the nums array/vector from the end. nums.size()-1 done because c++ indexing starts from zero.
