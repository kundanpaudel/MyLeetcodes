...
public:
    int maxProfit(vector<int>& prices) {
        ...
        while(rightPointer<prices.size()){ // Loop until right pointer reaches end of the array.
            if(prices[leftPointer]<=prices[rightPointer]){ // If price at left is smaller than price at right
